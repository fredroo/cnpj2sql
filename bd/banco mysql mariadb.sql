...
CREATE TABLE IF NOT EXISTS cnpj.empresas (
  ...
  porte TINYINT(2) UNSIGNED ZEROFILL NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS cnpj.estabelecimentos (
  ...
  data_situacao_cadastral DATE NULL DEFAULT NULL,
  ...
  ddd_1 SMALLINT(4) UNSIGNED NULL DEFAULT NULL,
  telefone_1 INT(9) UNSIGNED NULL DEFAULT NULL,
  ddd_2 SMALLINT(4) UNSIGNED NULL DEFAULT NULL,
  telefone_2 INT(9) UNSIGNED NULL DEFAULT NULL,
  ddd_fax SMALLINT(4) UNSIGNED NULL DEFAULT NULL,
  num_fax INT(9) UNSIGNED NULL DEFAULT NULL,
  email VARCHAR(150) NULL DEFAULT NULL,
  INDEX fk_estabe_empresas_idx (cnpj_basico ASC),
...
CREATE TABLE IF NOT EXISTS cnpj.socio (
  ...
  INDEX fk_socio_empresas1_idx (cnpj_basico ASC),
...
CREATE TABLE IF NOT EXISTS cnpj.simples (
  cnpj_basico INT(8) UNSIGNED ZEROFILL NOT NULL,
  optante_simples TINYINT(1) NOT NULL DEFAULT 0,
  data_opcao_simples DATE NULL DEFAULT NULL,
  data_exclusao_simples DATE NULL DEFAULT NULL,
  mei TINYINT(1) NOT NULL DEFAULT 0,
  data_opcao_mei DATE NULL DEFAULT NULL,
  data_exclusao_mei DATE NULL DEFAULT NULL,
  INDEX fk_simples_empresas1_idx (cnpj_basico ASC),
  CONSTRAINT fk_simples_empresas1
    FOREIGN KEY (cnpj_basico)
    REFERENCES cnpj.empresas (cnpj_basico)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
